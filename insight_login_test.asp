<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="insight_login_test.aspx.vb" Inherits="insight_login_test" %>
        ...
        <tbody>
            <tr>
                <td valign="middle" align="center" class="auto-style1">
                    <img src="images/ttl_client_login.gif" alt=""> </td>
...
//--></script>
       ...
       <!-- <form method="post" action="insight_login.asp?action=logon" lang="JavaScript" target="_self"> -->
	                <form method=post action="insight_login.asp?action=logon" name=FrontPage_Form1 onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" style="width: 350px">
                        <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MEMBERS AREA<br /></b>
                        <br><font face="Courier New, Courier, mono" size=2>Email Address:</font><font color="#ff0000">*</font><br><font face="Courier">
                        <input maxlength="100" name="email1" size="50" style="width: 300px"></font> <font size=1>
                        <br></font><font face="Courier New, Courier, mono" size="2">Password:</font><font color="#ff0000">*</font><br><font face="Courier">
                        <input maxlength="35" name="password1" size="30" 
          type="password" style="width: 200px"><br /></font>
                        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font face="Courier">
                        <input type="image" src="images/submit.gif" value="submit" name="I1" align="top" style="text-align: left"></font><br />
                        <img src="images/clear.gif" height="15" border="0" alt=""><br><font face="Verdana" size="1" color="#000000"><b>Forgot your Password?</b>
      If you're the primary account contact, click <a href="insight_login.asp?action=sendpw">here</a>
      and we will email it to you.<br />&nbsp;</font><br>
                    </form>
                </td>
            </tr>
        </tbody>
...
<script Language="JavaScript" Type="text/javascript"><!--
    ...
    <form method=post action="insight_login.asp?action=addclient" name=FrontPage_Form2 onsubmit="return FrontPage_Form2_Validator(this)" language="JavaScript">
        <table border="1" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF" bordercolordark="#C0C0C0" width="75%">
            <tr>
                <td colspan="2">
                    <p align=justify>
                        <font face="Verdana" size="1"><%=rs("Data")%></font>
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="center"><b><span style="text-transform: uppercase"><font face="Verdana" size="3" color="#000080">Online Client Registration</font></span> </b>
                    <br><font face="Verdana" size="1">(</font><font color="#ff0000">*</font><font face="Verdana" size="1"> denotes required
      field)</font></td>
            </tr>
            <tr>
	...
	CoCode:</font><br><font face="Verdana" size="1">(if applicable)</font></td>
                <td><font size="2" face="Courier">
                    ...
                    <INPUT name="cocode" size=10></font></td>
            </tr>
            <tr>
      ...
      State, Zip Code:</font><font color="#ff0000">*</font></td>
            ...
            <tr>
                ...
                <td><font size="2" face="Courier">
                    <INPUT name="country" size=25></font></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><font face="Courier">
                    <input type=text name=farea size=3 maxlength=3></font>-<font face="Courier"><input type=text name=fexchange size=3 maxlength=3></font>-<font face="Courier"><input type=text name=fnumber size=4 maxlength=4></font></td>
            </tr>
            <tr>
                <td align="right">&nbsp;</td>
                <td>
                    <p align="justify">
                        <font face="Verdana" size="1">The following will be your authorization ID and password that will allow you to access the "Account Management
      Page.&quot; If you forget your password, we will email it to this email
      address.</font></p>
                </td>
            </tr>
            <tr>
                <td align="right"><font face="Verdana" size="1">Authorization ID<br>(E-Mail Address):</font><font color="#ff0000">*</font></td>
                <td><FONT size=2 face="Courier">
                    <INPUT name="email2" size=50 maxlength="100"> </FONT></td>
            </tr>
            <tr>
                <td align="right"><font face="Verdana" size="1">Password:</font><font color="#ff0000">*</font></td>
                <td><FONT size=2 face="Courier">
                    <INPUT name="password2" size=30 type="password"></FONT></td>
            </tr>
            <tr>
                <td colspan="2" align="center">&nbsp;</td>
            </tr>
...
%>
            ...
            <tr>
                <td align="right"><font face="Verdana" size="1">Quantity:</font><font color="#ff0000">*</font></td>
                <td align="left" width="300"><font size="2" face="Courier">
                    <INPUT name=qty size=8 value="5"> </font><font face="Verdana" size="2">Click <a href="javascript:myopen()">here</a> to see pricing info</font> </td>
            </tr>
            <tr>
                <td align="right">&nbsp;</td>
                <td align="left">
                    <input type="checkbox" name="newsletter" value="-1"> <font face="Verdana" size="2">Check
      ...
      mailing list for special offers or new services/products.</font></td>
            ...
            <tr>
                <td align="center">
                    <p align="center">
                        <input type="image" src="images/submit.gif"  value="add" name="I2" align="top"></td>
                <td align="center">
                    <p align="justify">
                        <font face="Verdana" size="1">After submitting this
      ...
      hit the submit button again, this will duplicate your order.<BR>
                        <BR>If you experience difficulties, please Contact Us or call&nbsp; <b>
                        <br>800-852-2001
    ...
    <form method=post action="insight_login.asp?action=sendpw2" name="sendpw" onSubmit="return validateForm2(this)">
      ...
      to you.</font> </td>
            ...
            <tr>
                <td>
                    <p align="right">
                        <font face="Verdana" size="2"><b>email address:</b></font></td>
                <td><font face="Courier">
                    <INPUT maxLength=50 name=email size=50></font><br>
                    <img  alt=""name=emailerror src="images/blankimage.gif"  height=10 border=0></td>
                <td>
                    <center>
                        <input type="image" src="images/submit.gif" value="submit" name="submit" align="left"></center>
                </td>
            </tr>
        </table>
    </form>
...
<% case "duplicateacct" %>
    <p>
        &nbsp;</p>
<center>
    <b><span style="font-variant: small-caps"><font face="Arial" size="4" color="#000080">account exists</font></span></b>
    <blockquote>
        <blockquote>
            <blockquote>
                <p align="justify">
                    <font face="Verdana" size="2" color="#000080"><b>You have entered
...
<center>
    ...
    <blockquote>
        <blockquote>
            <blockquote>
                <p align="justify">
                    <font face="Verdana" size="2" color="#000080"><b>You have entered an
...
<center>
    ...
    <blockquote>
        <blockquote>
            <blockquote>
                <p align="justify">
                    <font face="Verdana" size="2" color="#000080"><b>We have
    ...
    <table width="50%" border="0" cellspacing="5" cellpadding="5">
        <tr>
            <td width="64%" height="242">
                <p align="justify" class="auto-style3">
                    If you require special accommodations or are uncomfortable 
        ...
        operations are all that are required to respond to NSight assessment questions.</p>
                <p align="justify" class="auto-style3">
                    Upon your acceptance of the following terms, please proceed 
        ...
        questions.</p>
                <p align="justify" class="auto-style3">
                    In consideration for being permitted to complete NSight, 
        ...
        results to be given directly to the company that has requested it. 
                </p>
...
//--></script>
                ...
                <form method="POST" action="insight_login.asp?action=logon" name="FrontPage_Form4" target="_self" onsubmit="return FrontPage_Form4_Validator(this)" language="JavaScript">
                    <p align="left">
                        Authorization ID:<font color="#ff0000"> *</font>&nbsp;
