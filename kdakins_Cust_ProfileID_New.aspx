...
<title>kdakins_Cust_ProfileID_Viewer</title>
...
<body>&nbsp;<form id="form1" runat="server">
            ...
            <tr>
                ...
                <td align="center">
					...
					<asp:ImageButton ID="ImageButton3" runat="server" 
                        ImageUrl="gfx/Calendar_scheduleHS.png" onclick="ImageButton3_Click" 
                        style="height: 16px" />
                </td>
                <td align="center">
                ...
                Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" 
                Visible="False" Width="200px" 
                onselectionchanged="Calendar2_SelectionChanged1" CssClass="style1">
                <SelectedDayStyle BackColor="#666666" Font-Bold="True" ForeColor="White" />
                <SelectorStyle BackColor="#CCCCCC" />
                <WeekendDayStyle BackColor="#FFFFCC" />
                <TodayDayStyle BackColor="#CCCCCC" ForeColor="Black" />
		...
		<p class="style1">
            Start Date: <asp:TextBox id="TextBox1" runat="server" Width="150px" 
                CssClass="style1">6/1/2013</asp:TextBox>
			&nbsp;<asp:ImageButton id="ImageButton1" runat="server" 
                onclick="ImageButton1_Click" ImageUrl="gfx/Calendar_scheduleHS.png" />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			&nbsp;<asp:ImageButton ID="ImageButton2" runat="server" 
                onclick="ImageButton2_Click" ImageUrl="gfx/Calendar_scheduleHS.png" />
		&nbsp;&nbsp;&nbsp;
            </p>
			<div class="style1">
				<asp:GridView id="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" 
				Caption="Verio Test ProfileID Viewer (Time is EST)" CellPadding="4" DataKeyNames="ProfileID" 
				...
				<Columns>
    				<asp:hyperlinkfield DataNavigateUrlFields="ProfileID" DataNavigateUrlFormatString="http://nsightsuccess.com/insight_mgmt3.asp?action=results2&amp;
		...
		<div class="style1">
			<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:insi40ConnectionString %>" 
                ...
                SelectCommand="SELECT ProfileID, DateTaken, ProductID, Salutation, First, Last, Email, Position, pwUsed, FirstName, LastName, Company, PDesc FROM ProfileID_Customer WHERE (DateTaken &gt;= @DateTaken) AND (DateTaken &lt;= @DateTaken2) AND (Company = N'U.S. Venture, Inc.') AND (FirstName = N'Kelly') AND (LastName = N'Dakins') AND (ProductID = 6) ORDER BY ProfileID DESC">
				<SelectParameters>
					<asp:controlparameter ControlID="TextBox1" Name="DateTaken" PropertyName="Text" 
                        Type="DateTime" DefaultValue="06/01/2013"/>
